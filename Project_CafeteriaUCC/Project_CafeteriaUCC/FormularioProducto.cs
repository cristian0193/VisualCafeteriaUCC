...
namespace Project_CafeteriaUCC
{
    public partial class FormularioProducto : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            codigo_producto = txt_codigo_producto.Text;

            consuta_producto = producto.ConsultarProduto(codigo_producto);

            if (!txt_codigo_producto.Text.Equals("") && !txt_nombre_producto.Text.Equals("") && !txt_cantidad.Text.Equals("") && !txt_precio.Text.Equals("") && !combo_categoria.SelectedIndex.Equals(-1) ) 
            {
