...
namespace Dao
{
    ...
    {
        int insertProveedor(int id_proveedor, String nombre_asesor, String apellido_asesor, String nit_empresa, String direccion, String telefono, String nombre_empresa, String productos_ofrece);
